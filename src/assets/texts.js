export const home = {
    ...
    content: [
        `A GenIS é uma empresa inovadora que vai transformar a vida 
        ...
        `Imagine ter acesso aos seus dados genéticos e poder aproveitar 
        uma medicina personalizada, feita especialmente para você. `,
        `Junte-se a nós e descubra como a ciência pode ser sua aliada na 
    ...
    infoData: {
        infoPizza: {
            txt: `70% de todas as mortes no mundo são causadas por doenças crônicas 
            não transmissíveis, como doenças cardiovasculares, câncer, diabetes e 
            doenças respiratórias crônicas.`,
            quote: '(WHO, 2021)'
        },
        infoArrow: {
            txt1: 'O número de adultos com ',
            txt2: '+ de 30 anos',
...
export const products = {
    ...
    content: [
        `As doenças crônicas não transmissíveis, como as doenças 
        ...
        `Uma dessas doenças é a hipertensão arterial. Nos últimos 30 anos, 
        ...
        Saúde Brasil, 2021).`,
        `Entender a relação entre nossa genética e nossa fisiologia pode 
...
export const about = {
    ...
    purpose: {
        ...
        text: `Transformar conhecimento genético em um resultado personalizado que 
                possibilite maior qualidade de vida para as pessoas.`
    },
    values: {
        title: 'Nós da GenIS acreditamos que...',
